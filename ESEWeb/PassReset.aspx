<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PassReset.aspx.cs" Inherits="ESEWeb.PassReset" %>
...
<body>
    ...
    <div class="flex-title">
        ...
        <br />
        <asp:Button ID="btnRegister" CssClass="btn" runat="server" Text="Reset" OnClick="btnRegister_Click"/>
        <br />
        <br />
